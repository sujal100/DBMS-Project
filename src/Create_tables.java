...
public class Create_tables {
  ...
  public static void main(String args[]) {
    ...
    // DROP all the table in database to not already exists error second run se comment out kar lena
    // try {
    //   Statement stmt = c.createStatement();
    //   String sql = "DROP TABLE Research_Paper;";
    //   stmt.executeUpdate(sql);
    //   sql = "DROP TABLE Author;";
    //   stmt.executeUpdate(sql);
    //   sql = "DROP TABLE Conference;";
    //   stmt.executeUpdate(sql);
    ...
    //  for creteing table of Research_Paper
    try {
      Statement stmt = c.createStatement();
      String sql =
    ...
    //  for creteing table of Conference
    try {
      Statement stmt = c.createStatement();
      String sql =
    ...
    //  for creteing table of written_by
    try {
      Statement stmt = c.createStatement();
      String sql =
        ...
        " Co_Author INTEGER, " + // Co_Author jab multiple hoga tho data repeat karega
        " PRIMARY KEY ( paper_id ))"; // primary key Research_Paper se aai hui paper_id hogi
      stmt.executeUpdate(sql);
    ...
    //  for creteing table of cited_by
    try {
      Statement stmt = c.createStatement();
      String sql =
        "CREATE TABLE cited_by " + // iss table mai primary key nahi rakh sakte
